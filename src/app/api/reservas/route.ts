...
export async function POST(req: NextRequest) {
  ...
  const hasClassesLeft = activePkg.classes_total === null || activePkg.classes_used < activePkg.classes_total
  if (!hasClassesLeft) return NextResponse.json({ error: 'Has usado todas las clases de tu paquete' }, { status: 400 })
