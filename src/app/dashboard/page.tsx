...
import { Video, MapPin, Calendar, BookOpen, ExternalLink, Package, Gift, Users } from 'lucide-react'
              ...
              <div key={booking.id} className="bg-white rounded-2xl border border-stone-200 p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    {booking.guest && (
                      <p className="text-xs text-[#4a6741] flex items-center gap-1 mt-1">
                        <Users className="w-3 h-3" /> +1 invitado · −2 clases
                      </p>
                    )}
